export const ru = {
  ...
  family: {
    ...
    leaveConfirm: 'Покинуть эту семью? После выхода семья и её члены перестанут быть для вас видимыми.',
    leaveSuccess: 'Вы покинули семью.',
    leaveFailed: 'Не удалось покинуть семью.',
    ownerCannotLeave: 'Владелец семьи не может покинуть семью'
  },
  member: {
    title: 'Члены семьи',
